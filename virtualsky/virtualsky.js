...
// update methods to do something useful XXX
...
// export api
// window.fullScreenApi = fullScreenApi; XXX
...
VirtualSky.prototype.drawImmediate = function(proj){
	...
	c.lineWidth = 1.5;
	this.setFont();
	this.container.css({'font-size':this.fontsize()+'px','position':'absolute'}); // XXX
	...
	if(this.showplanets || this.showplanetlabels){
		...
		if(this.sun) {
			...
			if(this.isVisible(pos.el) && !this.isPointBad(pos)){
				this.drawSun(pos.x,pos.y,35,this.col.sun,"sun");
		...
		if(this.moon) {
			...
			if(this.isVisible(pos.el) && !this.isPointBad(pos)){
				this.drawMoon(pos.x,pos.y,15,this.col.moon,"moon");
...
VirtualSky.prototype.drawSun = function(x,y,d,colour,label){
	var c = this.ctx;
	c.beginPath();
	c.fillStyle = colour;
	c.strokeStyle = colour;
...
VirtualSky.prototype.drawMoon = function(x,y,d,colour,label){
	var c = this.ctx;
	c.beginPath();
	c.fillStyle = colour;
	c.strokeStyle = colour;
...
/* VirtualSky.prototype.toggleFullScreen = function(){ XXXX
